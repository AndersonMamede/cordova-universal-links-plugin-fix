# THIS IS A FORK...
...of an unmaintained cordova plugin with unmerged pull request to fix an issue in AndroidManifest.xml path https://github.com/nordnet/cordova-universal-links-plugin/pull/135
